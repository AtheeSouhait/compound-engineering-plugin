...
## [3.4.0](https://github.com/AtheeSouhait/compound-engineering-plugin/compare/compound-engineering-v3.3.2...compound-engineering-v3.4.0) (2026-05-01)


### Features

* **ce-brainstorm,ce-plan:** surface agent's scope synthesis before doc-write ([#705](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/705)) ([41e7f72](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/41e7f72ab697b3aee9b4a740794daa55317f44d1))
* **ce-brainstorm:** probe rigor gaps with prose before Phase 2 ([#677](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/677)) ([304a975](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/304a975d02b362eac8e715e482f0118ee623da91))
...
* **ce-simplify-code:** add skill for simplifying recent code changes ([#735](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/735)) ([2d20757](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/2d207574123782722116bd3d93f9f5756fab4dd3))
...
* **ce-test-browser:** free-port scan and auto-server start ([f8720da](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/f8720da3d1ba9e6d9fc161a6377f3ba83a8ab978))
* **ce-test-browser:** gate port scan and auto-start on pipeline mode ([22d493b](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/22d493b192108970a3d54378f8de2fd72ac62863))
* **lfg:** add ce-commit-push-pr step and remove ralph-loop ([1f20c38](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/1f20c3842d26a02ed8baca13eb737ca635320719))


### Bug Fixes

* **ce-code-review:** comment-gate previous-comments persona to skip empty PRs ([#720](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/720)) ([09fa18b](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/09fa18bcc1f130b7af26dfc53974776f1434b53d))
* **ce-code-review:** mandate walkthrough.md load on walk-through entry ([#718](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/718)) ([5ac1a06](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/5ac1a063a9c154bb586a5f2b2ad17ef59990c0b6))
...
* **ce-commit-push-pr:** URL-encode parens in badge model-slug examples ([#725](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/725)) ([3873b9e](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/3873b9e9de483cfe91eaed295a6b736d0a2e1168))
* **ce-compound-refresh:** check inbound links before deletion ([#713](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/713)) ([e806522](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/e806522caab45f07f7bd3f06d6b1333068c538cd))
...
* **ce-debug:** default to commit-and-PR and tighten learning offer ([#693](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/693)) ([e21156e](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/e21156eeb7e1502a37bf7d4a30fdc6a3287eed7a))
...
* **ce-doc-review:** tighten suggested_fix and why_it_matters rules ([#702](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/702)) ([dd08094](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/dd080943e0bff65416c5a3b16bcc6c3e1d26524f))
* **ce-ideate:** sharpen bug intent, surprise-me dispatch, and drop authoring refs ([#672](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/672)) ([f0433d9](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/f0433d9150b0c62a1fd65db7ffdb08a7c45fdb7f))
* **ce-plan:** close synthesis drift in rich-context invocations ([#729](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/729)) ([15c1cde](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/15c1cde7b353d8f309b5a2de94bafb99380d787a))
...
* **ce-resolve-pr-feedback:** add declined verdict for harmful suggestions ([#694](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/694)) ([bd72818](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/bd72818609054f6d173cf141641799fa729cc668))
...
* **ce-test-browser:** skip headed/headless question in pipeline mode ([47350c3](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/47350c3e4e612fa341d8e43e4d1709ab391fbe42))
...
* **ce-work:** codify worktree isolation for parallel subagent dispatch ([#698](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/698)) ([053c1db](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/053c1db25511843b5967b3d04427b172ede98d25))
* **commit-push-pr:** branch from fresh remote base to prevent stale-base contamination ([#708](https://github.com/AtheeSouhait/compound-engineering-plugin/issues/708)) ([cd2fc67](https://github.com/AtheeSouhait/compound-engineering-plugin/commit/cd2fc67c3f2db9b98de16a10d2a1e8e11700985e))
